...
namespace TravelBooking.Infrastructure.Consumers;

/// <summary>
/// Simulates inventory reservation since there's no real inventory system.
...
public class ReserveInventoryConsumer : IConsumer<ReserveInventoryCommand>
{
    ...
    public async Task Consume(ConsumeContext<ReserveInventoryCommand> context)
    {
        ...
        // Simulate success (in production, this would check real inventory)
